...
<section class="bothSide_gap">
    <div class="cust_container">
        ...
        <h2 class="heading">Train Dashboard</h2>
        ...
        <div class="custom_card">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="hostgame-tab" data-bs-toggle="tab" data-bs-target="#hostgame" type="button" role="tab" aria-controls="hostgame" aria-selected="true">+ New Host</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="hostgame" role="tabpanel" aria-labelledby="hostgame-tab">
                    <?php include "train-game-create.php"; ?>
                </div>
                <div class="tab-pane fade" id="Scheduled" role="tabpanel" aria-labelledby="Scheduled-tab">
                    <?php include "train-scheduled-game.php"; ?>
                </div>
                <div class="tab-pane fade" id="Completed" role="tabpanel" aria-labelledby="Completed-tab">
                    <?php include "train-complete-game.php"; ?>
                </div>
                <div class="tab-pane fade" id="Payment" role="tabpanel" aria-labelledby="Payment-tab">
                    <?php include "train-payment-list.php"; ?>
                </div>
            </div>
            <!----All-Event-tab-End------->

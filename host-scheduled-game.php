...
?>
    <div class="custom_card">
        <!--<h6 class="card_heading">The Upcoming Games</h6>-->
        <div class="d-flex align-items-center justify-content-between mb-2">
            <h6 class="mb-0 fw-bold text-primary">The Upcoming Games</h6>
        ...
        <div class="mb-3">
                <form>
                    <div class="row g-1 align-items-center">
                        <div class="col-auto">
                            <select class="form-select form-select-sm py-0" id="year" aria-label="Default select example" style="width: auto; min-width: 130px; height: 31px;">
                        ...
                        <div class="col-auto">
                            <select class="form-select form-select-sm py-0" id="month" aria-label="Default select example" style="width: auto; min-width: 130px; height: 31px;">

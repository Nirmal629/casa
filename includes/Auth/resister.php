...
<div class="modal fade" id="registerRequestModal" tabindex="-1" aria-labelledby="registerRequestModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="registerRequestModalLabel">Register Request Now</h1>
            ...
            <div class="modal-body">
                <form id="industrialRegisterForm">
                    ...
                    <div class="row mb-2 align-items-center">
                        <label class="col-sm-4 form-label-bold">Area*</label>
                        <div class="col-sm-8">
                    ...
                    <div class="info-box border-top my-1">
                        <p class="fw-bold mb-1">Important Login Information</p>
                        <div class="border-top p-0 mt-3 mb-2">
                    ...
                    <!-- Message Area -->
                    <div id="responseMsg" class="mt-2 text-center py-2 rounded" style="display:none; font-weight:bold;"></div>
            ...
            $.ajax({
                ...
                error: function() {
                    $msg.css({
                        'background': '#f8d7da',
                        'color': '#842029'
                    }).show().html('System Error: Connection failed.');
                    $btn.prop('disabled', false).text('Submit Registration');
                }
            });
        });

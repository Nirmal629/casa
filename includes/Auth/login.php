        ...
        if ($result->num_rows === 1) {
            ...
            if ($PASSWORD === trim($user['PASSWORD'])) {
                ...
                if ($user['USERTYPE'] === 'Host' || $user['USERTYPE'] === 'Trainer') {
                    header("Location: https://casainfotech.com/staging/host-dashboard.php");
                } elseif ($user['USERTYPE'] === 'Player') {
                    header("Location: https://casainfotech.com/staging/player-hub.php");
                } else {
                    header("Location: https://casainfotech.com/staging/trainer-dashboard.php");
                }
                exit;
            } else {

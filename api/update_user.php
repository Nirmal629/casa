...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($password!='')
    {
        ...
        $sql = "UPDATE ca_users 
            SET NAME = '$name', EMAIL = '$email', PASSWORD='$hashed_password',  EMAIL_PERMISSION = '$email_permission', WHATSAPP_NUMBER = '$whatsapp_number', CALL_PERMISSION = '$call_permission', DOB = '$dob', GENDER = '$gender', CITY = '$city', COUNTRY = '$country', PROVINCE = '$province', CURRENCY = '$currency', LEVEL='$level', TIMEZONE_OFFSET = '$timezone_offset' 
            WHERE ID = $user_id";
    }
    else
    {
        $sql = "UPDATE ca_users 
            SET NAME = '$name', EMAIL = '$email',  EMAIL_PERMISSION = '$email_permission', WHATSAPP_NUMBER = '$whatsapp_number', CALL_PERMISSION = '$call_permission', DOB = '$dob', GENDER = '$gender', CITY = '$city', COUNTRY = '$country', PROVINCE = '$province', CURRENCY = '$currency', LEVEL='$level', TIMEZONE_OFFSET = '$timezone_offset' 
            WHERE ID = $user_id";
    }

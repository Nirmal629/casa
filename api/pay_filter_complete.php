...
";
    ...
    $sql .= ' ORDER BY ce.EVENT_DATE DESC, ce.EVENT_TIME DESC';
    // Execute query
    ...
    AND cg.STATUS = 'Y' 
    AND ce.STATUS = 'Completed' AND NOT (ce.EVENT_CATEGORY = 'PreviousDue' OR ce.EVENT_CATEGORY LIKE 'Carry Forward from %') AND YEAR(ce.EVENT_DATE) = '$currentYear' AND MONTH(ce.EVENT_DATE) = '$currentMonth' ORDER BY ce.EVENT_DATE DESC, ce.EVENT_TIME DESC");

...
if (!function_exists('logPlayerActivity')) {
     ...
     * Backwards compatible: extra args optional; safe before the audit-log migration.
     *
     * @param int|string   $host_id  owning host for game activity (NULL for global events)
